...
exports.bulk = (data, options) => {
  ...
  return got.post(formatUrl(dbUrl), gotOptions)
}

exports.week = (date, options) => exports.getView(
  'vents',
  'bystart',
  Object.assign(
    {
      query: {
        ...
        endkey: JSON.stringify([new Date(Date.parse(date) + weekms).toISOString().split('T')[0]]),
        include_docs: true
      }
    },
    options || {}
